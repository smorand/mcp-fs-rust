...
//!
//! The 55 tool names, descriptions and `inputSchema` values are a client and an
...
//! description change shows up as one line; 55 changed tools means something went
...
const NOTE: &str = "Frozen MCP tool contract: the 55 tool names, descriptions and inputSchema \
...
fn tool_contract_golden_is_current() {
    ...
    assert_eq!(reg.len(), 55, "the frozen contract covers 33 fs, 8 admin and 14 git tools");
