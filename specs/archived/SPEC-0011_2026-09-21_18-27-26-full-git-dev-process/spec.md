...
| `specs/archived/SPEC-0010_2026-09-21_00-34-13-github-enterprise-and-token-store/spec.md` | Host map, per-host token store, remote pipeline, pull with `on_conflict`. **Implemented**; its 19 stories are in `specs/stories/`. |
...
| `specs/SPEC-0007_2026-09-18_19-45-00-git/spec.md` | git tool surface | **Extended** | 18 tools become 49 in the git family. |
...
`specs/archived/SPEC-0010_2026-09-21_00-34-13-github-enterprise-and-token-store/spec.md` is implemented
