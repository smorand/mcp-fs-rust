...
| Spec | Scope |
|---|---|
| `specs/2026-09-18_17-37-46-platform-foundation.md` | Server assembly, identity, safety, errors |
| `specs/2026-09-18_18-05-00-filesystem-engine.md` | `core::fs_ops`, the filesystem operations |
| `specs/2026-09-18_18-30-00-rest-data-plane.md` | `/api/fs` and OpenAPI |
| `specs/2026-09-18_18-55-00-multi-backend-storage.md` | The relational layer and backends |
| `specs/2026-09-18_19-20-00-documents.md` | Extraction, docx, symbols |
| `specs/2026-09-18_19-45-00-git.md` | **Git objects, HTTP smart protocol, OAuth device flow. Owns `FR-601`–`FR-629`.** |
| `specs/2026-09-18_20-10-00-search-and-rag.md` | Search tools and indexing |
| `specs/2026-09-18_20-35-00-optional-integrations.md` | Optional integrations |
...
#### FR-MOD-001 [EARS-E]: Provider resolution replaces substring detection (references `specs/2026-09-18_19-45-00-git.md`)
...
|---|---|---|---|
| `specs/2026-09-18_19-45-00-git.md` | `FR-624` | Modified | Device authorization gains a host dimension (FR-MOD-002). |
| `specs/2026-09-18_19-45-00-git.md` | `FR-629` | Modified | Status and revocation become per host (FR-MOD-003, FR-MOD-004). |
| `specs/2026-09-18_19-45-00-git.md` | `FR-627` | Preserved | Encryption at rest unchanged. |
| `specs/2026-09-18_19-45-00-git.md` | `FR-628` | Preserved | Conditional persistence unchanged; FR-NEW-017 adds a loud failure when persistence is configured and fails. |
| `specs/2026-09-18_19-45-00-git.md` | `FR-609` | Preserved and relied upon | Per-repository write serialization is what makes concurrent pushes safe; FR-NEW-044 prevents a hung remote from holding the lock. |
| `specs/2026-09-18_19-45-00-git.md` | `FR-612`, `FR-613` | Preserved | Membership gating and auth-only gating unchanged; FR-NEW-040 extends the admin-has-no-implicit-access rule to tokens. |
| `specs/2026-09-18_19-45-00-git.md` | `FR-604`, `FR-605` | Relied upon | Export-before-read and import-after-write are the mechanism push, fetch and pull use. |
| `specs/2026-09-18_18-55-00-multi-backend-storage.md` | Backend parity | Impacted | The `oauth_tokens` key change must pass the conformance suite on all three engines. |
...
`specs/2026-09-18_19-45-00-git.md` is **not modified**. Three deviations from it are recorded
here.
